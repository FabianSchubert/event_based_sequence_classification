...
// ------------------------------------------------------------------------
EXPORT_FUNC void pushMergedNeuronInitGroup0ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, float* prevST, scalar* r_trace, scalar* r, scalar* r_event, scalar* r_prev_event, float* inSynInSyn0, float* inSynInSyn1, unsigned int numNeurons);
...
EXPORT_FUNC void pushMergedNeuronInitGroup2ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, float* prevST, scalar* r, scalar* r_event, scalar* r_prev_event, int* t_idxCS0, int* periodicCS0, scalar* t_dataCS0, scalar* dt_dataCS0, int* ntCS0, unsigned int numNeurons);
EXPORT_FUNC void pushMergedNeuronInitGroup3ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, float* prevST, scalar* r, scalar* x, scalar* dr, scalar* b, scalar* db, scalar* err_fb, scalar* r_event, scalar* r_prev_event, float* inSynInSyn0, float* inSynInSyn1, unsigned int numNeurons);
EXPORT_FUNC void pushMergedSynapseInitGroup0ToDevice(unsigned int idx, scalar* g, scalar* inp_prev, unsigned int numSrcNeurons, unsigned int numTrgNeurons, unsigned int rowStride, scalar sdg);
EXPORT_FUNC void pushMergedSynapseInitGroup1ToDevice(unsigned int idx, scalar* g, scalar* inp_prev, scalar* dg, scalar* dg_prev, scalar* t_prev, unsigned int numSrcNeurons, unsigned int numTrgNeurons, unsigned int rowStride, scalar sdg);
...
EXPORT_FUNC void pushMergedNeuronUpdateGroup0ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, float* prevST, scalar* r_trace, scalar* r, scalar* r_event, scalar* r_prev_event, float* inSynInSyn0, float* inSynInSyn1, uint32_t* recordSpk, unsigned int numNeurons);
...
EXPORT_FUNC void pushMergedNeuronUpdateGroup2ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, float* prevST, scalar* r, scalar* r_event, scalar* r_prev_event, int* t_idxCS0, int* periodicCS0, scalar* t_dataCS0, scalar* dt_dataCS0, int* ntCS0, scalar* dataCS0, unsigned int numNeurons);
EXPORT_FUNC void pushMergedNeuronUpdate2dataCS0ToDevice(unsigned int idx, scalar* value);
EXPORT_FUNC void pushMergedNeuronUpdateGroup3ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, float* prevST, scalar* r, scalar* x, scalar* dr, scalar* b, scalar* db, scalar* err_fb, scalar* r_event, scalar* r_prev_event, float* inSynInSyn0, float* inSynInSyn1, unsigned int numNeurons);
EXPORT_FUNC void pushMergedPresynapticUpdateGroup0ToDevice(unsigned int idx, float* inSyn, unsigned int* srcSpkCnt, unsigned int* srcSpk, scalar* rPre, scalar* r_prev_eventPre, float* prevSTPre, scalar* g, scalar* inp_prev, unsigned int numSrcNeurons, unsigned int numTrgNeurons, unsigned int rowStride);
EXPORT_FUNC void pushMergedPresynapticUpdateGroup1ToDevice(unsigned int idx, float* inSyn, unsigned int* srcSpkCnt, unsigned int* srcSpk, scalar* rPre, float* prevSTPre, scalar* g, scalar* inp_prev, unsigned int numSrcNeurons, unsigned int numTrgNeurons, unsigned int rowStride);
EXPORT_FUNC void pushMergedPresynapticUpdateGroup2ToDevice(unsigned int idx, float* inSyn, unsigned int* srcSpkCnt, unsigned int* srcSpk, scalar* rPre, scalar* drPost, scalar* errPost, float* prevSTPre, scalar* g, scalar* inp_prev, scalar* dg, scalar* dg_prev, scalar* t_prev, unsigned int numSrcNeurons, unsigned int numTrgNeurons, unsigned int rowStride);
EXPORT_FUNC void pushMergedPresynapticUpdateGroup3ToDevice(unsigned int idx, float* inSyn, unsigned int* srcSpkCnt, unsigned int* srcSpk, scalar* r_tracePre, scalar* rPre, scalar* drPost, scalar* err_fbPost, float* prevSTPre, scalar* g, scalar* inp_prev, scalar* dg, scalar* dg_prev, scalar* t_prev, unsigned int numSrcNeurons, unsigned int numTrgNeurons, unsigned int rowStride);
EXPORT_FUNC void pushMergedPresynapticUpdateGroup4ToDevice(unsigned int idx, float* inSyn, unsigned int* srcSpkCnt, unsigned int* srcSpk, scalar* drPre, scalar* errPre, scalar* rPost, float* prevSTPre, scalar* g, scalar* inp_prev, scalar* dg, scalar* dg_prev, scalar* t_prev, unsigned int numSrcNeurons, unsigned int numTrgNeurons, unsigned int rowStride);
