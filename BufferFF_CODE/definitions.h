...
EXPORT_VAR uint32_t* recordSpkp_h;
EXPORT_VAR uint32_t* d_recordSpkp_h;
...
EXPORT_VAR scalar* dr_err_prodp_h;
EXPORT_VAR scalar* d_dr_err_prodp_h;
EXPORT_VAR scalar* weight_factorp_h;
EXPORT_VAR scalar* d_weight_factorp_h;
...
EXPORT_VAR uint32_t* recordSpkp_i;
EXPORT_VAR uint32_t* d_recordSpkp_i;
...
EXPORT_VAR scalar* r_tracep_i;
EXPORT_VAR scalar* d_r_tracep_i;
// current source variables
EXPORT_VAR int* t_idxcs_in;
EXPORT_VAR int* d_t_idxcs_in;
EXPORT_VAR int* periodiccs_in;
EXPORT_VAR int* d_periodiccs_in;
EXPORT_VAR int* nt_datacs_in;
EXPORT_VAR int* d_nt_datacs_in;
...
EXPORT_VAR uint32_t* recordSpkp_o;
EXPORT_VAR uint32_t* d_recordSpkp_o;
...
EXPORT_VAR int* nt_datacs_out;
EXPORT_VAR int* d_nt_datacs_out;
...
EXPORT_VAR scalar* mplast_step_reduced_w_hi;
EXPORT_VAR scalar* d_mplast_step_reduced_w_hi;
EXPORT_VAR scalar* vplast_step_reduced_w_hi;
EXPORT_VAR scalar* d_vplast_step_reduced_w_hi;
EXPORT_VAR scalar* timeplast_step_reduced_w_hi;
EXPORT_VAR scalar* d_timeplast_step_reduced_w_hi;
...
EXPORT_VAR scalar* reducedChangereduce_batch_weight_change_w_hi;
EXPORT_VAR scalar* d_reducedChangereduce_batch_weight_change_w_hi;
...
EXPORT_VAR float* inSynw_hi;
EXPORT_VAR float* d_inSynw_hi;
...
// synapse variables
// ------------------------------------------------------------------------
EXPORT_VAR scalar* gw_hi;
EXPORT_VAR scalar* d_gw_hi;
EXPORT_VAR scalar* inp_prevw_hi;
EXPORT_VAR scalar* d_inp_prevw_hi;
EXPORT_VAR scalar* dgw_hi;
EXPORT_VAR scalar* d_dgw_hi;
EXPORT_VAR scalar* dg_prevw_hi;
EXPORT_VAR scalar* d_dg_prevw_hi;
EXPORT_VAR scalar* t_prevw_hi;
EXPORT_VAR scalar* d_t_prevw_hi;
...
EXPORT_FUNC void pushdr_err_prodp_hToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pulldr_err_prodp_hFromDevice();
EXPORT_FUNC void pushCurrentdr_err_prodp_hToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullCurrentdr_err_prodp_hFromDevice();
EXPORT_FUNC scalar* getCurrentdr_err_prodp_h(unsigned int batch = 0); 
EXPORT_FUNC void pushweight_factorp_hToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullweight_factorp_hFromDevice();
EXPORT_FUNC void pushCurrentweight_factorp_hToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullCurrentweight_factorp_hFromDevice();
EXPORT_FUNC scalar* getCurrentweight_factorp_h(unsigned int batch = 0); 
...
EXPORT_FUNC void pushr_tracep_iToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullr_tracep_iFromDevice();
EXPORT_FUNC void pushCurrentr_tracep_iToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullCurrentr_tracep_iFromDevice();
EXPORT_FUNC scalar* getCurrentr_tracep_i(unsigned int batch = 0); 
...
EXPORT_FUNC void pushnt_datacs_inToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullnt_datacs_inFromDevice();
...
EXPORT_FUNC void pushnt_datacs_outToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullnt_datacs_outFromDevice();
...
EXPORT_FUNC void pushmplast_step_reduced_w_hiToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullmplast_step_reduced_w_hiFromDevice();
EXPORT_FUNC void pushvplast_step_reduced_w_hiToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullvplast_step_reduced_w_hiFromDevice();
EXPORT_FUNC void pushtimeplast_step_reduced_w_hiToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pulltimeplast_step_reduced_w_hiFromDevice();
EXPORT_FUNC void pushplast_step_reduced_w_hiStateToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullplast_step_reduced_w_hiStateFromDevice();
...
EXPORT_FUNC void pushreducedChangereduce_batch_weight_change_w_hiToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullreducedChangereduce_batch_weight_change_w_hiFromDevice();
EXPORT_FUNC void pushreduce_batch_weight_change_w_hiStateToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullreduce_batch_weight_change_w_hiStateFromDevice();
...
EXPORT_FUNC void pushgw_hiToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullgw_hiFromDevice();
EXPORT_FUNC void pushinp_prevw_hiToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullinp_prevw_hiFromDevice();
EXPORT_FUNC void pushdgw_hiToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pulldgw_hiFromDevice();
EXPORT_FUNC void pushdg_prevw_hiToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pulldg_prevw_hiFromDevice();
EXPORT_FUNC void pusht_prevw_hiToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullt_prevw_hiFromDevice();
EXPORT_FUNC void pushinSynw_hiToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullinSynw_hiFromDevice();
EXPORT_FUNC void pushw_hiStateToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullw_hiStateFromDevice();
